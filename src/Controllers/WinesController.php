...
class WinesController extends Controller {
    ...
    /**
     * Affiche tous les vins de la base de données
     * @param RequestInterface $request
     * @param ResponseInterface $response
     */
    ...
    /**
     * Affiche les informations sur un vin
    ...
    public function test() {
        ...
        var_dump($model->add_wines('test3', 2017, 'testgrape', 'country', 'regtest', 'descr', 'testPicture'));
    }
